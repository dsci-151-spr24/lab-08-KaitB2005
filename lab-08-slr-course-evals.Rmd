...
***For an average beauty rating increased by 1 the average evaluation rating goes up by 0.07.*** 
...
***A male professor on average scores 0.14 higher than a female professor. On average a female professor scores 4.09 on the ratings. ***
...
11. Fit a new linear model called `score_rank_fit` to predict average professor evaluation `score` based on `rank` of the professor.
    ...
    ```
***The model is ***
***Score= 4.28 - 0.12 x Tenure Track -0.14 x Tenured***

$$\widehat{score}_i = 4.28 = 0.12\times TenureTrack_i = 0.14\times Tenured_i$$
***The average rating for a teaching track professor is 4.28. The average rating for a tenure track professor is 0.12 points lower than a teaching track professor. The average rating for a tenured professor is 0.4 points lover than a teaching professor.***
